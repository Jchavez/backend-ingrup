...
<?php echo $this->Form->create('CategoryProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Category Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CategoryProduct.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CategoryProduct.id'))); ?></li>
